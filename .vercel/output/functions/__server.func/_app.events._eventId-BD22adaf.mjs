...
import { t as apiEventToCampusEvent } from "./_ssr/useLiveEvents-DycTSZ8b.mjs";
import { n as format } from "./_libs/date-fns.mjs";
import { i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./_ssr/tabs-CCJRliUM.mjs";
import { n as registrationService, t as Route } from "./_app.events._eventId-C5yhrHJ4.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app.events._eventId-BD22adaf.js
	...
	(0, import_react.useEffect)(() => {
		if (!eventId.startsWith("evt-")) {
			...
			const tryFirestoreThenMySql = async () => {
				...
				try {
					const { API_BASE_URL } = await import("./_ssr/apiClient-DumwXFEP.mjs").then((n) => n.r).then((n) => n.n);
